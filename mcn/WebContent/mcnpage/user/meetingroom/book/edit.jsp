	...
	<form id="inputForm" action="update.do" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="name" value="${room.NAME}" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="num" value="${room.NUM}" class="text" maxlength="200" />
				</td>
				...
				<td>
					<select id="audit_id" name="audit_id" class="text" maxlength="200" >
						...
						<c:forEach items="${users}" var="row" varStatus="status">
							<c:choose>
								<c:when test="${row.ID == room.AUDIT_ID}">
