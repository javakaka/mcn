	...
	<form id="listForm" action="RoomList.do" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'name'}"> class="current"</c:if> val="name">会议室名称</a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'num'}">class="current"</c:if> val="num">会议室容积</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="name">会议室名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="num">会议室容积</a>
				</th>
				
				<th>
					<a href="javascript:;" >审批人</a>
				</th>
				<!--
				<th>
					<a href="javascript:;" class="sort" name="STATE">会议室状态</a>
				</th>
				<th>
