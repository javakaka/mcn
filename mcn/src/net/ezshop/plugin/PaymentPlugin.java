...
import net.ezshop.service.PluginConfigService;
...
public abstract class PaymentPlugin implements Comparable<PaymentPlugin> {
	...
	public FeeType getFeeType() {
		PluginConfig pluginConfig = getPluginConfig();
		System.out.println("pluginconfig plugin id-->"+pluginConfig.getPluginId());
		System.out.println("pluginconfig id-->"+pluginConfig.getId());
		System.out.println("pluginconfig mdate-->"+pluginConfig.getModifyDate());
	...
	public BigDecimal getFee() {
		...
		else 
		{
			...
			temp =pluginConfig.getAttribute(FEE_ATTRIBUTE_NAME);
