package net.ezshop.plugin.paypal;
...
import net.ezshop.controller.admin.BaseController;
import net.ezshop.entity.PluginConfig;
import net.ezshop.plugin.PaymentPlugin;
import net.ezshop.plugin.PaymentPlugin.FeeType;
import net.ezshop.plugin.paypal.PaypalPlugin.Currency;
...
public class PaypalController extends BaseController {
	...
	public String setting(ModelMap model) {
		...
		return "/net/ezshop/plugin/paypal/setting";
	}
