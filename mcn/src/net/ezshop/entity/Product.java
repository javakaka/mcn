...
import net.ezshop.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity {
	...
	static {
		try {
			...
			org.dom4j.Document document = new SAXReader().read(ezshopXmlFile);
			org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/ezshop/template[@id='productContent']");
