...
import net.ezshop.service.AreaService;
import net.ezshop.service.CartService;
...
import net.ezshop.service.ShippingService;
	...
	public String payment(String sn, ModelMap model) {
		...
		if (order.getPaymentMethod().getMethod() == PaymentMethod.Method.online) {
			...
			if (!paymentPlugins.isEmpty()) {
				...
				System.out.println(":"+defaultPaymentPlugin.getId());
				
				System.out.println(":"+defaultPaymentPlugin.getRequestUrl());
				System.out.println(":"+defaultPaymentPlugin.getName());
				System.out.println(":"+defaultPaymentPlugin.getPaymentName());
				System.out.println(":"+defaultPaymentPlugin.getAuthor());
				System.out.println(":"+defaultPaymentPlugin.getRequestCharset());
				if (order.getPaymentStatus() == PaymentStatus.unpaid || order.getPaymentStatus() == PaymentStatus.partialPayment) {
					//check the pay plugin is  have enabled
