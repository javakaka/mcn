...
import net.ezshop.Principal;
import net.ezshop.Setting;
import net.ezshop.Setting.CaptchaType;
import net.ezshop.entity.Area;
import net.ezshop.entity.Cart;
import net.ezshop.entity.Member;
import net.ezshop.entity.MemberAttribute;
import net.ezshop.entity.BaseEntity.Save;
import net.ezshop.entity.Member.Gender;
import net.ezshop.entity.MemberAttribute.Type;
import net.ezshop.service.AreaService;
import net.ezshop.service.CaptchaService;
import net.ezshop.service.CartService;
import net.ezshop.service.MemberAttributeService;
import net.ezshop.service.MemberRankService;
import net.ezshop.service.MemberService;
import net.ezshop.service.RSAService;
import net.ezshop.util.SettingUtils;
import net.ezshop.util.WebUtils;
