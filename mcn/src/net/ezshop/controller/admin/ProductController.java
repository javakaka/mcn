...
import net.ezshop.FileInfo.FileType;
import net.ezshop.entity.Attribute;
import net.ezshop.entity.Brand;
import net.ezshop.entity.Goods;
...
import net.ezshop.entity.ProductCategory;
import net.ezshop.entity.ProductImage;
...
import net.ezshop.entity.Product.OrderType;
import net.ezshop.entity.Tag.Type;
import net.ezshop.service.BrandService;
import net.ezshop.service.FileService;
import net.ezshop.service.GoodsService;
import net.ezshop.service.MemberRankService;
import net.ezshop.service.ProductCategoryService;
import net.ezshop.service.ProductImageService;
import net.ezshop.service.ProductService;
import net.ezshop.service.PromotionService;
import net.ezshop.service.SpecificationService;
import net.ezshop.service.SpecificationValueService;
import net.ezshop.service.TagService;
