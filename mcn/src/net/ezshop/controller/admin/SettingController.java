...
import net.ezshop.Setting.AccountLockType;
import net.ezshop.Setting.CaptchaType;
import net.ezshop.Setting.ConsultationAuthority;
import net.ezshop.Setting.ReviewAuthority;
import net.ezshop.Setting.RoundType;
import net.ezshop.Setting.StockAllocationTime;
import net.ezshop.Setting.WatermarkPosition;
import net.ezshop.service.CacheService;
import net.ezshop.service.FileService;
import net.ezshop.service.MailService;
