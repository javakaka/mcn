...
import net.ezshop.Template;
import net.ezshop.dao.ArticleDao;
import net.ezshop.dao.BrandDao;
import net.ezshop.dao.ProductDao;
import net.ezshop.dao.PromotionDao;
	...
	public int build(String templatePath, String staticPath, Map<String, Object> model) {
		...
		try {
			...
			if(model == null)
			{
				...
				while(it.hasNext())
				{
					String o_name =(String)it.next();
					System.out.println("next==="+o_name);
					System.out.println("next==="+model.get(o_name));
				}
			}
