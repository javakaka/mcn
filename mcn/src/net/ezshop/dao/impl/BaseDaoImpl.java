...
import net.ezshop.Filter.Operator;
import net.ezshop.Order.Direction;
import net.ezshop.dao.BaseDao;
import net.ezshop.entity.OrderEntity;
	...
	private synchronized String getAlias(Selection<?> selection) {
		if (selection != null) {
			...
			if (alias == null) {
				...
				alias = "ezshopGeneratedAlias" + aliasCount++;
